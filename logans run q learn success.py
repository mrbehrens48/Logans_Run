...
this one loads a pre-trained q-table at the beginning, and just renders each game so you can see the dog running and fetching over and over
@author: mrbeh
"""
...
MOVE_PENALTY = -1 #the reward for taking a movement action
FETCH_REWARD = 500 #the reward for bringing back the stick!
COLLECT_REWARD = 50 #the reward for getting the stick
...
start_q_table = 'qtable-1587066558.pickle'
